...
export const EXAMPLE1_LINKS_STEP = 11;
export const EXAMPLE1_MARGIN_STEP = 12;
export const EXAMPLE1_AUTO_STEP = 13;
export const EXAMPLE1_CUSTOM_EVENT_STEP = 14;
export const EXAMPLE1_TIMEOUT_STEP = 15;
export const EXAMPLE1_EVENT_SELECTOR_STEP = 16;
export const EXAMPLE1_IFRAME_STEP = 17;
export const EXAMPLE1_SKIP_DEMO_STEP = 18;
export const EXAMPLE1_SHOW_NEXT_STEP = 20;
export const EXAMPLE1_TOTAL_STEPS = 21;
